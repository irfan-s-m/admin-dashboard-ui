...
const Home = () => {
    return (
        <div className="home grid grid-cols-4 px-6 gap-5 auto-rows-min-180">
            ...
            <div className="border border-solid border-softBg p-3 rounded-lg row-span-3 col-span-1"><PieChartBox></PieChartBox></div>
            ...
            <div className="border border-solid border-softBg p-3 rounded-lg"><BarChartBox></BarChartBox></div>
